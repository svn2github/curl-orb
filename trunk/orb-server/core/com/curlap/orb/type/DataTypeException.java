...
/**
 * Exception thrown during the data type formatting.
 * 
...
public class DataTypeException extends Exception 
{
     ...
     */
    public DataTypeException(String message, Throwable rootCause) 
    {
        super(message, rootCause);
    }

    /**
     * Create a new InstanceManagementException with the given root cause. 
     * 
     * @param rootCause the root cause
     */
    public DataTypeException(Throwable rootCause) 
    {
        super(rootCause);
    }
}