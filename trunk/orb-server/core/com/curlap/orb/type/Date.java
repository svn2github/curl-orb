...
/**
 * Proxy class of java.sql.Date to serializer and deserialize.
 * 
 * @author Ucai Zhang
 * @since 0.6
 */
public class Date extends AbstractSerializableProxyType  {

	private static final long serialVersionUID = 1L;

	/**
     * A variable contians the millsecond.
     * it is the same as fastTime in java.util.Date
     */
	protected long time ;
